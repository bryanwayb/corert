...
struct RuntimeInstanceDebugContract
{
	...
	const uint32_t offsetOfRuntimeInstanceThreadStore = offsetof(RuntimeInstance, m_pThreadStore);
	RuntimeInstance** const ppGlobalRuntimeInstance = &g_pTheRuntimeInstance;
};
